      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="magageLoout.php" class="text-white">logout</a></li>
  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      ...
      <form action="handleAddPost.php"  method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <textarea class="form-control" name="content" id="" rows="3" placeholder="ex: share your ideas"></textarea>
          </div>
